...
private:
	...
	void traverse_levelorder_NR(Node<T>* theRoot)
	 ...
	 int test_children_number(Node<T>* theRoot)
	 {
		 if ((theRoot->lChildptr == NULL && theRoot->rChildptr != NULL) || (theRoot->lChildptr != NULL && theRoot->rChildptr == NULL))
			 return 0;
    ...
    public:
		...
		int test_children_number()
		{
			if (root == NULL) return 1;
			else return test_children_number(root);
		}
